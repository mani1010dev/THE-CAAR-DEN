...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container-luxury px-4 sm:px-6 lg:px-8 pt-20">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            ...
            <a 
              href="https://wa.me/917538863909?text=Hi%20The%20Caar%20Den%2C%20I'd%20like%20to%20book%20a%20detailing%20session!" 
              target="_blank" 
